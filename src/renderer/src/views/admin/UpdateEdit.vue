    ...
    >
        ...
        >
            <el-form-item label="版本号" prop="version" >
                <el-input :maxlength="10" placeholder="eg:1.0.0" v-model="formData.version"></el-input>
            </el-form-item>
            ...
            <el-form-item label="外链地址" prop="outerLink" v-if="formData.fileType == 1">
                <el-input :maxlength="200" placeholder="请输入完整的外链地址" v-model="formData.outerLink"></el-input>
            </el-form-item>
            <el-form-item label="更新内容" class="update-form-item">
                <div class="update-desc-item" v-for="(item, index) in formData.updateDescList" :key="index">
                    <el-form-item 
                    ...
                    >
                        <div class="update-desc">
                            ...
                            <div class="input">
                                <el-input :maxlength="11" v-model="item.title" placeholder="请输入更新内容"></el-input>
                            </div>
...
const rules= {
    version: [
        ...
        {validator: proxy.Verify.version, message: '版本号只能是数字和点组成'}
    ],
...
const showEdit = (data) =>{
    ...
    nextTick(()=>{
        ...
        if(data){
            ...
            data.fileName = 'MyChat.' + data.version + '.exe'
        }
