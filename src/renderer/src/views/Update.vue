        ...
        <div class="update-inner">
            <div class="update-content">
                ...
                <div class="update-list">
                    <div v-for="(item, index) in updateInfo.updateDescArray" :key="index">{{ index + 1 }}、{{ item }}</div>
                </div>
            </div>
            <div class="download-progress" v-if="downloading">
                <div v-if="downloadPercent.progress != 100">
                    ...
                    <div class="download-tips">
                        正在下载，请稍后({{ proxy.Utils.size2Str(downloadPercent.loaded) }}/{{ proxy.Utils.size2Str(downloadPercent.total) }})
                    </div>
                </div>
