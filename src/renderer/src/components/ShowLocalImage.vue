...
const serverUrl = computed(()=>{
    ...
    const url =  `http://127.0.0.1:${serverPort}/file?partType=${props.partType}&fileId=${props.fileId}&fileType=${props.fileType}&showCover=true&forceGet=${props.forceGet}&${new Date().getTime()}`
    return url
})
</script>
